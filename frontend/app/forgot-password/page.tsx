          ...
          {step === 'email' ? (
            <form onSubmit={handleSendOTP} className="space-y-4">
              ...
              <div className="text-center pt-4">
                <Link 
                  href="/login" 
                  className="text-sm text-[#195ADC] hover:text-[#195ADC]/80 font-medium inline-flex items-center gap-1"
                >
            ...
            <div className="space-y-6">
              ...
              <Button
                ...
                className="w-full h-10 bg-[#195ADC] hover:bg-[#195ADC]/90 text-white font-medium"
