...
export function MovieTeamLoginForm() {
  ...
  useEffect(() => {
    ...
    if (error === "user_not_found") {
      message =
        "No event operations account found for this email. Please sign up first.";
      ...
      if (error === "access_denied") {
        message =
          details ||
          "This login is for event operations members only. Please use the regular login page.";
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (userRole !== "organizer") {
        ...
        throw new Error(
          "This login is for event operations members only. Please use the regular login page if you are a general user.",
        );
      }
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            isSignUp
              ? "Create your event operations account"
              ...
              !isSignUp &&
                /*#__PURE__*/ React.createElement(
                  "button",
                  {
                    ...
                    className:
                      "text-xs text-purple-600 hover:text-purple-700 font-medium cursor-pointer",
                  },
                  "Forgot password?",
                ),
            ),
            ...
            isSignUp &&
              ...
              (() => {
                ...
                return /*#__PURE__*/ React.createElement(
                  ...
                  {
                    className:
                      "mt-2 p-3 bg-purple-50 rounded-lg border border-purple-200",
                  },
                  /*#__PURE__*/ React.createElement(
                    "p",
                    {
            ...
            isLoading
              ? /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    {
                      className:
                        "mr-2 inline-flex h-4 w-4 items-center justify-center text-white",
                    },
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            "button",
            {
              ...
              disabled: isLoading,
              className:
                "text-sm text-purple-600 hover:text-purple-700 font-medium transition-colors disabled:opacity-50",
            },
            isSignUp
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(Input, {
              ...
              required: true,
              className:
                "h-11 border-2 border-slate-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20",
            }),
          ),
          /*#__PURE__*/ React.createElement(CityInput, {
