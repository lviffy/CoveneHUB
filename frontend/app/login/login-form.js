...
export function LoginForm() {
  ...
  const handledAuthErrorRef = useRef(null);
  ...
  const handleSignUp = async (e) => {
    ...
    // Validate full name
    const { isValid: isNameValid, error: nameError } =
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      document.cookie =
        "pending_google_signup=; Max-Age=0; Path=/; SameSite=Lax";
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      Card,
      {
        className: "w-full max-w-md border border-slate-200 shadow-sm",
      },
      /*#__PURE__*/ React.createElement(
        CardHeader,
        {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            isSignUp
              ? "Join CONVENEHUB to discover and book live events"
        ...
        /*#__PURE__*/ React.createElement(
          ...
          isSignUp &&
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Input, {
                ...
                className: `h-11 border-2 transition-all duration-200 focus:ring-2 focus:ring-[#195ADC]/20 ${fullNameError ? "border-red-400 focus:border-red-400" : "border-slate-200 focus:border-[#195ADC]"}`,
              }),
              fullNameError &&
                /*#__PURE__*/ React.createElement(
                  "p",
              ...
              !isSignUp &&
                /*#__PURE__*/ React.createElement(
                  "button",
                  {
                    ...
                    className:
                      "text-xs text-[#195ADC] hover:text-[#195ADC]/80 font-medium cursor-pointer",
                  },
                  "Forgot password?",
                ),
            ),
            ...
            isSignUp &&
              ...
              (() => {
                ...
                return /*#__PURE__*/ React.createElement(
                  ...
                  {
                    className:
                      "mt-2 p-3 bg-slate-50 rounded-lg border border-slate-200",
                  },
                  /*#__PURE__*/ React.createElement(
                    "p",
                    {
                      className: "text-xs font-medium text-slate-700 mb-2",
                    },
          ...
          /*#__PURE__*/ React.createElement(
            Button,
            {
              type: "submit",
              className:
                "w-full h-10 bg-[#195ADC] hover:bg-[#195ADC]/90 text-white font-medium mt-6",
              disabled: isLoading,
            },
            isLoading
              ? /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            "button",
            {
              ...
              disabled: isLoading,
              className:
                "text-sm text-[#195ADC] hover:text-[#195ADC]/80 font-medium transition-colors disabled:opacity-50",
            },
            isSignUp
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-xs text-slate-500",
                },
                "or",
              ),
            ),
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(Input, {
              ...
              className:
                "h-11 border-2 border-slate-200 focus:border-[#195ADC] focus:ring-2 focus:ring-[#195ADC]/20",
            }),
          ),
          /*#__PURE__*/ React.createElement(CityInput, {
        ...
        /*#__PURE__*/ React.createElement(
          DialogFooter,
          {
            className: "flex flex-row gap-2 sm:gap-2",
          },
          /*#__PURE__*/ React.createElement(
            Button,
            {
          ...
          /*#__PURE__*/ React.createElement(
            Button,
            {
              ...
              disabled:
                !googleSignupData.city ||
                !googleSignupData.phone ||
                googleSignupData.phone.trim().length < 10,
            },
            "Continue with Google",
          ),
        ),
