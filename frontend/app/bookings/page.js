...
export default function MyBookingsPage() {
    ...
    try {
      ...
      bookingsList.forEach(async (booking) => {
        if (
          ...
          setTimeout(
            () => fetchAllTicketQrsForBooking(booking.booking_id),
            100,
          );
        }
      });
      ...
      if (tickets.length === 0 && data.booking) {
        try {
          const createResp = await fetch(
            `/api/bookings/${bookingId}/create-missing-tickets`,
            {
              method: "POST",
            },
          );
  ...
  const fetchAllTicketQrsForBooking = useCallback(
    async (bookingId) => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      default:
        return /*#__PURE__*/ React.createElement(Badge, null, status);
    }
  };
      ...
      !error &&
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            "Free (",
            bookings.filter((b) => !b.payment_required).length,
            ")",
          ),
          /*#__PURE__*/ React.createElement(
            Button,
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    /*#__PURE__*/ React.createElement(
                      ...
                      /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(
                          ...
                          /*#__PURE__*/ React.createElement(Calendar, {
                            className:
                              "h-4 w-4 mt-0.5 text-gray-500 flex-shrink-0",
                          }),
                          /*#__PURE__*/ React.createElement(
                            "span",
                            null,
                            format(
                              new Date(booking.event.date_time),
                        ...
                        /*#__PURE__*/ React.createElement(
                          ...
                          /*#__PURE__*/ React.createElement(
                            ...
                            " ",
                            booking.tickets_count === 1 ? "Ticket" : "Tickets",
                          ),
                        ),
                      ...
                      (booking.payment_status === "PENDING" ||
                        ...
                        /*#__PURE__*/ React.createElement(
                          ...
                          /*#__PURE__*/ React.createElement(
                            ...
                            {
                              className:
                                "bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-3",
                            },
                            /*#__PURE__*/ React.createElement(
                              "div",
                              {
                              ...
                              /*#__PURE__*/ React.createElement(AlertCircle, {
                                className:
                                  "h-5 w-5 text-yellow-600 mt-0.5 flex-shrink-0",
                              }),
                              /*#__PURE__*/ React.createElement(
                                "div",
                                {
                                ...
                                /*#__PURE__*/ React.createElement(
                                  ...
                                  {
                                    className:
                                      "font-medium text-yellow-900 mb-1",
                                  },
                                  booking.payment_status === "PENDING" ||
                                    booking.payment_status === "pending"
                                    ? "Payment Pending"
                      ...
                      (booking.booking_status === "confirmed" ||
                        ...
                        new Date(booking.event.date_time) > new Date() &&
                        // Event hasn't happened yet
                        (booking.event.status === "published" ||
                          booking.event.status === "checkin_open") &&
                        /*#__PURE__*/ React.createElement(
                          "div",
                          {
                            className: "pt-4 border-t",
                        ...
                        /*#__PURE__*/ React.createElement(
                            ...
                            selectedBooking === booking.booking_id && qrCode
                              ? /*#__PURE__*/ React.createElement(
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    ...
                                    {
                                      className:
                                        "relative w-full aspect-square max-w-[220px] mx-auto bg-white p-4 rounded-lg border-2",
                                    },
                                    /*#__PURE__*/ React.createElement(Image, {
                                      src: qrCode,
                                      alt: "Booking QR Code",
                                  ...
                                  /*#__PURE__*/ React.createElement(
                                    ...
                                    /*#__PURE__*/ React.createElement(
                                      ...
                                      {
                                        onClick: () =>
                                          downloadQRCode(booking.booking_code),
                                        className: "flex-1",
                                        variant: "outline",
                                      },
                                      /*#__PURE__*/ React.createElement(
                              ...
                              : /*#__PURE__*/ React.createElement(
                                  ...
                                  {
                                    onClick: () =>
                                      fetchQRCode(booking.booking_id),
                          ...
                          /*#__PURE__*/ React.createElement(
                            ...
                            loadingTicketsMap[booking.booking_id]
                              ...
                              : ticketsMap[booking.booking_id] &&
                                  ticketsMap[booking.booking_id].length > 0
                                ? /*#__PURE__*/ React.createElement(
                                    "div",
                                    {
                                    ...
                                    ticketsMap[booking.booking_id].map((t) =>
                                      /*#__PURE__*/ React.createElement(
                                        "button",
                                        {
                                          ...
                                          className:
                                            "bg-gray-50 rounded-lg p-3 border border-gray-200 text-center hover:bg-gray-100 hover:border-blue-400 transition-all cursor-pointer",
                                        },
                                        /*#__PURE__*/ React.createElement(
                                          "div",
                                          {
                                        ...
                                        /*#__PURE__*/ React.createElement(
                                          ...
                                          {
                                            className:
                                              "text-xs font-mono text-gray-600 mb-2",
                                          },
                                          t.ticket_code,
                                        ),
                                        t.checked_in &&
                                          /*#__PURE__*/ React.createElement(
                                            ...
                                            {
                                              className:
                                                "bg-green-100 text-green-800 text-xs mb-2",
                                            },
                                            "\u2713 Checked In",
                                          ),
                                        loadingTicketQrMap[t.ticket_id]
                                          ...
                                          : /*#__PURE__*/ React.createElement(
                                              ...
                                              {
                                                className:
                                                  "flex items-center justify-center gap-1 text-xs text-blue-600 mt-2",
                                              },
                                              /*#__PURE__*/ React.createElement(
                                                QrCode,
                                                {
                          ...
                          booking.event.entry_instructions &&
                            /*#__PURE__*/ React.createElement(
                              ...
                              {
                                className:
                                  "text-xs text-gray-600 bg-blue-50 p-3 rounded mt-4",
                              },
                              /*#__PURE__*/ React.createElement(
                                "strong",
                                null,
                      ...
                      booking.booking_status === "checked_in" &&
                        /*#__PURE__*/ React.createElement(
                          ...
                          /*#__PURE__*/ React.createElement(
                            ...
                            {
                              className:
                                "flex items-center gap-2 text-green-600 bg-green-50 p-3 rounded",
                            },
                            ...
                            /*#__PURE__*/ React.createElement(
                              ...
                              ticketsMap[booking.booking_id]?.some(
                                (t) => !t.checked_in,
                              )
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                "Ticket ",
                selectedTicketQR.ticket.ticket_number,
              ),
              /*#__PURE__*/ React.createElement(
                "p",
                {
                ...
                selectedTicketQR.ticket.ticket_code,
              ),
            ),
            /*#__PURE__*/ React.createElement(
              "button",
          ...
          selectedTicketQR.ticket.checked_in &&
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "mb-4 p-3 bg-green-50 rounded-lg border border-green-200",
              },
              /*#__PURE__*/ React.createElement(
                "div",
                {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            {
              className:
                "relative w-full aspect-square bg-white p-4 rounded-lg border-2 border-gray-200 mb-4",
            },
            /*#__PURE__*/ React.createElement(Image, {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                "p",
                null,
                "Present this QR code at the event entrance for check-in. Each ticket must be scanned individually.",
              ),
            ),
          ),
        ),
    ...
    showCancelDialog &&
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-200",
          },
          /*#__PURE__*/ React.createElement(
            "div",
            {
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "w-12 h-12 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0",
              },
              /*#__PURE__*/ React.createElement(AlertCircle, {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                bookingToCancel.tickets,
                " ticket(s) will be released and become available for other users to book.",
              ),
            ),
          ),
          /*#__PURE__*/ React.createElement(
