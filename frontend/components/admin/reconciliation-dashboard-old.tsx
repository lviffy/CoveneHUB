...
import { AlertCircle, CheckCircle2, Clock, TrendingUp, Users, UserCheck, UserX, CreditCard, AlertTriangle } from 'lucide-react';
...
export default function ReconciliationDashboard() {
  ...
  const [selectedMetric, setSelectedMetric] = useState<'checkin_rate' | 'payment_status' | 'no_shows'>('checkin_rate');
    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Reconciliation Overview</h2>
            <p className="text-gray-600">Track attendance vs bookings across all events</p>
          </div>
          <div className="bg-white rounded-xl p-4 shadow-sm">
            <div className="text-3xl font-bold text-blue-600">{summary.overall_checkin_rate.toFixed(0)}%</div>
