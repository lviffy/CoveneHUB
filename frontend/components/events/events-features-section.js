...
const features = [
  ...
  },
  {
    ...
    description:
      "Trusted organizers and verified listings for a secure experience.",
  },
  {
    icon: Bell,
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            motion.div,
            {
              ...
              className:
                "mb-6 inline-flex items-center gap-2 text-sm uppercase tracking-wide text-gray-500",
            },
          ...
          flows.map((flow, index) => {
            ...
            return /*#__PURE__*/ React.createElement(
              motion.div,
              {
                ...
                className:
                  "relative overflow-hidden rounded-2xl border border-gray-200 bg-[#F9FAFB] p-8",
              },
                ...
                flow.steps.map((step, stepIndex) =>
                  /*#__PURE__*/ React.createElement(
                    ...
                    /*#__PURE__*/ React.createElement(
                      ...
                      {
                        className:
                          "rounded-full bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm",
                      },
                      step,
                    ),
          ...
          features.map((feature, index) =>
            /*#__PURE__*/ React.createElement(
              motion.div,
              {
                ...
                className:
                  "group rounded-2xl bg-[#F9FAFB] p-8 transition-all duration-300 hover:-translate-y-1",
              },
              /*#__PURE__*/ React.createElement(
                "div",
                {
                  className:
                    "mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-white text-gray-900 shadow-sm",
                },
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "text-[15px] font-medium leading-relaxed text-gray-500",
                },
                feature.description,
              ),
            ),
