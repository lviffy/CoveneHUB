  ...
  const fetchOrganizerEvents = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorPayload?.message || errorPayload?.error || 'Failed to fetch organizer events');
      }
        ...
        >
          ...
          <div className="flex gap-1 sm:gap-2 p-1 bg-gray-100 rounded-lg w-full overflow-x-auto scrollbar-hide mb-6 sm:mb-8">
            {[
              ...
              { value: 'create-event', label: 'Create Event', shortLabel: 'Create', icon: Plus },
                { value: 'reconciliation', label: 'Reconcile', shortLabel: 'Reconcile', icon: BarChart3 },
          ...
          <div className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    {loading ? (
                      ...
                      <div className="text-center py-16">
                        ...
                        <Button className="mt-4" onClick={() => setActiveTab('create-event')}>
                ...
                <Card className="border-gray-200 shadow-sm">
                  <CardHeader className="border-b border-gray-100 bg-gray-50/50">
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        Create and publish your own event with VIP and General ticket tiers
                      </CardDescription>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
            ...
            {activeTab === 'reconciliation' && (
              <motion.div
                ...
                transition={{ duration: 0.4 }}
              >
                <ReconciliationDashboard apiBasePath="/api/organizer" />
              </motion.div>
            )}
                ...
                <Card className="border-gray-200 shadow-sm">
                  <CardHeader className="border-b border-gray-100 bg-gray-50/50">
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        Configure your organizer preferences
                      </CardDescription>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
